...
_MAX_TOOL_STREAM_LINE_BYTES = 4 * 1024 * 1024
...
_MANAGED_BACKEND_CODENAME_ENV = "GPTBRIDGE_MANAGED_BACKEND_CODENAME"
_TOOL_GOVERNANCE_BOOTSTRAP_ENV = "GPTBRIDGE_TOOL_GOVERNANCE_BOOTSTRAP"
_TOOL_VERSION_PATTERN = re.compile(r"^\d+\.\d+(?:\.\d+)?$")
...
_NETWORK_ISOLATION_BLOCKED_ENV = frozenset(
    {
        ...
        "GPTBRIDGE_MANAGED_BACKEND_CODENAME",
