...
_FALLBACK: Final[dict[str, Any]] = {
    ...
    "governed_startup": {
        ...
        "phase_budget_ms": {
            "phase-0-local-preflight": 500,
            "phase-1-minimal-information-bootstrap": 500,
            "phase-2-read-official-codex": 1000,
            "phase-3-load-permission-directory": 500,
            "phase-4-switch-normal-information-mode": 500,
            "phase-5-classify-dependency-dag": 1000,
            "phase-6-activate-core-sovereigns": 25000,
        },
        "startup_phases": (
