...
_FALLBACK: Final[dict[str, Any]] = {
    ...
    "governed_startup": {
        ...
        "phase_budget_ms": {
            ...
            "phase-3-load-permission-directory": 400,
            "phase-4-switch-normal-information-mode": 400,
            "phase-5-classify-dependency-dag": 2400,
            "phase-6-activate-core-sovereigns": 5000,
        },
        "startup_phases": (
