"""Resilient shared layer — types, circuit breaker, and helpers.

Provides the data structures, circuit breaker, and helper functions
used by the ResilientSharedLayerStore.
"""
