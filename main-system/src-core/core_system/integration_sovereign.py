"""Integration Sovereign — owns ALL cross-sovereign-module structural interface concerns.

Per the Governance Codex (A32 / E19 / P15), the Integration Sovereign is
responsible for every cross-sovereign and cross-module structural interface,
channel, synchronization and bus concerns.  It is the sole owner of
structural-interface matters; no other sovereign or module may take them over
(E20 boundary).
...
INTEGRATION_SOVEREIGN_ROLE = "integration-sovereign"

INTEGRATION_DECISION_AREA = "integration"


class IntegrationSovereign:
    """In-process sovereign responsible for ALL cross-sovereign-module structural interface functions.
    ...
    ROLE = INTEGRATION_SOVEREIGN_ROLE
    ...
    async def start(
        ...
        *,
        ...
        """Start the Integration Sovereign and its in-process supervision loop.
        ...
        if self._supervision_task is None:
            self._supervision_task = asyncio.create_task(
                ...
                name="integration-sovereign-supervision",
            )
