"""Data Sovereign — owns ALL data-body-related concerns, in-process.

Per the Governance Codex (A31 / E18 / P14), the Data Sovereign is
responsible for every data-BODY concern: structured data, semantic index,
and version history access specifications, consistency, integrity checks,
and data directory.  It is the sole owner of data-body matters; no other
...
DATA_SOVEREIGN_ROLE = "data-sovereign"

DATA_DECISION_AREA = "data"


class DataSovereign:
    """In-process sovereign responsible for ALL data-body functions.
    ...
    async def start(
        ...
        *,
        ...
        """Start the Data Sovereign and its in-process supervision loop.

        The sovereign captures the data-body governed executors from the app
        ...
        if self._supervision_task is None:
            self._supervision_task = asyncio.create_task(
                ...
                name="data-sovereign-supervision",
            )
