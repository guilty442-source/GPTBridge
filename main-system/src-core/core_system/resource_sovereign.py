"""Resource Sovereign — owns ALL resource-body-related concerns, in-process.

Per the Governance Codex (A30 / E17 / P13), the Resource Sovereign is
responsible for every resource-BODY concern: memory, disk, model and compute
resource state monitoring, provisioning and delegated release.  It is the sole
owner of resource-body matters; no other sovereign or module may take them over
(E20 boundary).
...
RESOURCE_SOVEREIGN_ROLE = "resource-sovereign"

RESOURCE_DECISION_AREA = "resource"


class ResourceSovereign:
    """In-process sovereign responsible for ALL resource-body functions.
    ...
    async def start(
        ...
        *,
        ...
        """Start the Resource Sovereign and its in-process supervision loop.
        ...
        if self._supervision_task is None:
            self._supervision_task = asyncio.create_task(
                ...
                name="resource-sovereign-supervision",
            )
