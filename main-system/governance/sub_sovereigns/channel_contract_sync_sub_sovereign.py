...
class ChannelContractSyncSubSovereign(SubSovereignBase):
    """In-process sub-sovereign responsible for information-channel governance.

    Responsibilities (A306/A322 — channel contract synchronization):
      - govern-channel-topology (A32/A153/E50)
      - coordinate-message-routing (A65/A153/E50)
      - govern-cross-module-contracts (A32/E19)

    Per A153/E50, channels are information-layer-only; this sub-sovereign
    GOVERNS topology and routing but does not own the channels.  Per E19,
    it is decision-only (EXEC:none) and never coordinates the decision layer
    itself.
    """
    ...
    async def start(
        ...
        The sub-sovereign captures the cross-module structural-interface
        governed executors from the app (decision-only supervision; it never
        executes the interface work in-process):
        ...
        # The permission sovereign (started by the app before the decision
    ...
    def _channel_topology_status(self) -> dict[str, Any]:
        ...
        This sub-sovereign GOVERNS channel topology; the channels themselves
        are owned by the information layer (A65/E50).
        """
        return {
    ...
    def _message_routing_status(self) -> dict[str, Any]:
        ...
        This sub-sovereign COORDINATES routing; the information layer owns the
        channels.
        """
        return {
    ...
    def _cross_module_contracts_status(self) -> dict[str, Any]:
        ...
        Per E19: ``EXEC:none; NO:decision-layer-coordinate`` — the
        sub-sovereign governs contracts but does not execute or coordinate
        the decision layer.
        """
        return {
