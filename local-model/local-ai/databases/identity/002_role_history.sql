...
CREATE TABLE IF NOT EXISTS role_history.personality_version (
    ...
    platform_id text NOT NULL DEFAULT 'local-model-platform', module_id text NOT NULL DEFAULT 'local-ai',
    owner_id text NOT NULL DEFAULT 'local-ai', data_category text NOT NULL DEFAULT 'role-setting',
