...
class StarCapabilityComposer:
        ...
        *,
        ...
        return {
            ...
            "implementation_target": (
                "src/backend/services/local_ai/application/composed_capabilities/"
    ...
    def _module_source(blueprint: dict[str, Any]) -> str:
        ...
        return (
            ...
            "        'source_write_authority': 'owner-approved-governed-local-ai-only',\n"
            "    }\n"
        )
            ...
            **blueprint,
            ...
            "authority": {
                **blueprint["authority"],
                ...
                "write_scope": "local-ai-composed-capabilities-only",
