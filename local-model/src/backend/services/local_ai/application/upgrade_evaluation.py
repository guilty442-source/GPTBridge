        ...
        recommendations.append(
            {
                ...
                "severity": "required",
                "action": "Request the centralized System Rescue repair procedure for local-ai through governance.",
            }
        )
        ...
        recommendations.append(
            {
                ...
                "severity": "required",
                "action": "Run the governed local-ai data compaction procedure.",
            }
        )
