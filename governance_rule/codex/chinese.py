...
GOVERNANCE_CODEX_CHINESE: Final[ChineseCodexReference] = ChineseCodexReference(
    ...
    articles=(
        ...
        ChineseCodexArticle(id="A37", section="四", subject="code-origin", rule="系統主宰及一切系統模組僅使用本機自有程式碼：Python、TypeScript、C++、C、C#、SQL 混合架構為唯一允許之程式語言；PostgreSQL、Qdrant、Git、RAG 為受治理之正式工具，其餘第三方軟體、套件、外部服務或非本機自有之執行環境不得依賴。", prohibition="禁止引用、安裝、匯入或執行任何非正式之第三方套件、外部服務、非本機自有之執行環境或二進位檔案"),
        ...
        ChineseCodexArticle(id="A44", section="四", subject="four-functions-local", rule="Git、PostgreSQL、語意索引、RAG 與 LLM 為正式工具與功能，由本機 Python、TypeScript、C++、C、C#、SQL 程式碼治理；若無法本機治理，則宣告不可用並保持關閉，不得以外部服務替代。", prohibition="禁止以非正式工具、外部服務或二進位替代任一本機功能"),
        ...
        ChineseCodexArticle(id="A49", section="四", subject="formal-tools", rule="PostgreSQL、Qdrant、Git、RAG、Python、TypeScript、C++、C、C#、SQL 為本法典指定之正式工具，悉數受本法典治理；其所有權為本機自有，須於本機環境運作，不得以外部或雲端服務託管；禁止以非正式工具替代。", prohibition="禁止以非正式或未經法典宣告之工具替代正式工具，亦禁止以外部或雲端服務託管任一正式工具"),
    ...
    edicts=(
        ...
        ChineseCodexEdict(id="E23", area="code-origin", edict="系統主宰及一切系統模組僅使用本機自有程式碼，Python、TypeScript、C++、C、C#、SQL 混合架構為唯一允許之程式語言；PostgreSQL、Qdrant、Git、RAG 為受治理之正式工具，禁止依賴任何非正式之第三方軟體、套件或外部服務。"),
        ...
        ChineseCodexEdict(id="E30", area="four-functions-local", edict="Git、PostgreSQL、語意索引、RAG 與 LLM 為正式工具與功能，由本機 Python、TypeScript、C++、C、C#、SQL 程式碼治理；無法本機治理即宣告關閉，不以外部服務替代。"),
        ...
        ChineseCodexEdict(id="E35", area="formal-tools", edict="PostgreSQL、Qdrant、Git、RAG、Python、TypeScript、C++、C、C#、SQL 為本法典指定之正式工具，悉數受本法典治理；其所有權為本機自有，須於本機運作，不得外部或雲端託管；禁止以非正式工具替代。"),
