...
GOVERNANCE_CODEX_CHINESE: Final[ChineseCodexReference] = ChineseCodexReference(
    ...
    principles=(
        ...
        ChineseCodexPrinciple(id="P18", statement="系統主宰及一切系統模組僅使用本機自有程式碼（Python、TypeScript、C++、C、C#、SQL 混合架構）；PostgreSQL、Qdrant、Git 與 RAG 為受治理之正式工具，其餘第三方軟體、套件或外部服務不得引用或執行。", binding=False),
    ...
    articles=(
        ...
        ChineseCodexArticle(id="A8", section="四", subject="system-responsibility", rule="Git 保存系統版本與歷史，PostgreSQL 保存結構化正式資料，Qdrant 保存語意索引，RAG 負責檢索增強（採 Hybrid RAG + Code RAG + Agentic RAG + Memory RAG 四子架構混合），LLM 負責理解推理與操作；PostgreSQL、Qdrant、Git、RAG、Python、TypeScript、C++、C、C#、SQL 為本機自有之正式工具，須於本機環境運作。", prohibition="四者不得互相取代；禁止以非正式工具替代"),
        ChineseCodexArticle(id="A9", section="四", subject="management-owner", rule="平台管理權屬星澄核心統籌，於治理法典之下行使唯讀管理權；工具層級管理權由工具擁有者於治理法典之下行使。", prohibition="禁止管理權擁有執行權或正式寫入權；禁止工具層級管理權繞過治理法典"),
        ...
        ChineseCodexArticle(id="A19", section="六", subject="xingcheng-thinking", rule="星澄之決策與管理思考一律引用本法典，以法典為來源；工具層級決策由工具擁有者於治理法典之下自行決定。", prohibition="禁止星澄憑自身推論凌駕或取代本法典；禁止工具層級決策繞過治理法典"),
        ...
        ChineseCodexArticle(id="A34", section="六", subject="boundary-integration-xingcheng", rule="整合主宰負責結構性介面與同步機制；星澄之協調屬平台層級決策協調與建議；工具層級決策由工具擁有者於治理法典之下行使。", prohibition="禁止整合主宰代行星澄之平台決策協調，亦禁止星澄代行整合之結構介面；禁止工具層級決策繞過治理法典"),
        ...
        ChineseCodexArticle(id="A37", section="四", subject="code-origin", rule="系統主宰及一切系統模組僅使用本機自有程式碼：Python、TypeScript、C++、C、C#、SQL 混合架構為唯一允許之程式語言；PostgreSQL、Qdrant、Git、RAG 為受治理之正式工具，其餘第三方軟體、套件、外部服務或非本機自有之執行環境不得依賴；內建瀏覽器為受治理之工具網路存取通道，不視為正式工具之替代。", prohibition="禁止引用、安裝、匯入或執行任何非正式之第三方套件、外部服務、非本機自有之執行環境或二進位檔案；禁止內建瀏覽器繞過治理法典"),
        ...
        ChineseCodexArticle(id="A44", section="四", subject="four-functions-local", rule="Git、PostgreSQL、語意索引、RAG 與 LLM 為正式工具與功能，由本機 Python、TypeScript、C++、C、C#、SQL 程式碼治理；若無法本機治理，則宣告不可用並保持關閉，不得以外部服務替代；內建瀏覽器為受治理之工具網路搜尋通道，外部 AI 須透過 ai-collaboration 工具接入。", prohibition="禁止以非正式工具、外部服務或二進位替代任一本機功能；禁止內建瀏覽器繞過治理法典；禁止未經 ai-collaboration 工具直接存取外部 AI"),
        ...
        ChineseCodexArticle(id="A49", section="四", subject="formal-tools", rule="PostgreSQL、Qdrant、Git、RAG、Python、TypeScript、C++、C、C#、SQL 為本法典指定之正式工具，悉數受本法典治理；其所有權為本機自有，須於本機環境運作，不得以外部或雲端服務託管；禁止以非正式工具替代；內建瀏覽器為工具網路存取通道，不視為正式工具之替代。", prohibition="禁止以非正式或未經法典宣告之工具替代正式工具，亦禁止以外部或雲端服務託管任一正式工具；禁止內建瀏覽器作為正式工具之替代"),
        ...
        ChineseCodexArticle(id="A58", section="四", subject="embedded-browser-governed-access", rule="內建瀏覽器為受治理之應用內瀏覽器視窗，由工具擁有模組管理；其用途為工具網路搜尋與外部 AI 協作；網路存取僅限內建瀏覽器視窗；外部 AI 須透過 ai-collaboration 工具接入；工具核心不得直接存取外部網路；內建瀏覽器不得作為正式工具之替代。", prohibition="禁止內建瀏覽器繞過治理法典、禁止未經 ai-collaboration 工具存取外部 AI、禁止內建瀏覽器替代正式工具、禁止工具核心直接存取網路"),
    ...
    edicts=(
        ...
        ChineseCodexEdict(id="E20", area="boundary", edict="各主宰職責互斥且獨立：資料完整性查核歸資料主宰，健康監控歸維護主宰，結構介面歸整合主宰，平台層級決策協調歸星澄，工具層級決策由工具擁有者於治理法典之下行使。"),
        ...
        ChineseCodexEdict(id="E23", area="code-origin", edict="系統主宰及一切系統模組僅使用本機自有程式碼，Python、TypeScript、C++、C、C#、SQL 混合架構為唯一允許之程式語言；PostgreSQL、Qdrant、Git、RAG 為受治理之正式工具，禁止依賴任何非正式之第三方軟體、套件或外部服務；內建瀏覽器為受治理之工具網路存取通道，不視為正式工具之替代。"),
        ...
        ChineseCodexEdict(id="E30", area="four-functions-local", edict="Git、PostgreSQL、語意索引、RAG 與 LLM 為正式工具與功能，由本機 Python、TypeScript、C++、C、C#、SQL 程式碼治理；無法本機治理即宣告關閉，不以外部服務替代；內建瀏覽器為受治理之工具網路存取通道，不視為正式工具之替代。"),
        ...
        ChineseCodexEdict(id="E35", area="formal-tools", edict="PostgreSQL、Qdrant、Git、RAG、Python、TypeScript、C++、C、C#、SQL 為本法典指定之正式工具，悉數受本法典治理；其所有權為本機自有，須於本機運作，不得外部或雲端託管；禁止以非正式工具替代；內建瀏覽器為工具網路存取通道，不作為正式工具之替代。"),
        ...
        ChineseCodexEdict(id="E44", area="embedded-browser-governed-access", edict="內建瀏覽器為受治理之應用內瀏覽器視窗，由工具擁有模組管理；用途為網路搜尋與外部 AI 協作；網路存取僅限內建瀏覽器視窗；外部 AI 須透過 ai-collaboration 工具接入；禁止工具核心直接存取網路、禁止內建瀏覽器作為正式工具之替代。"),
