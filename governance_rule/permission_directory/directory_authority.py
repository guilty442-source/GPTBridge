...
INDEPENDENT_TOOL_POLICY: Final[IndependentToolPolicy] = IndependentToolPolicy(
    ...
    temporary_root_template="Standalone tools/global-cleaner/runtime/temp/tools/{tool_id}",
...
SHARED_LAYER_ACCESS_POLICY: Final[SharedLayerAccessPolicy] = (
    SharedLayerAccessPolicy(
        ...
        temporary_root="Standalone tools/global-cleaner/runtime/temp/shared-layer",
