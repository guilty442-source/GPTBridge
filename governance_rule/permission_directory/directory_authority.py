...
from .directory_authority_types import (
...
INDEPENDENT_TOOL_POLICY: Final[IndependentToolPolicy] = IndependentToolPolicy(
    ...
    temporary_root_template="main-system/runtime/temp/tools/{tool_id}",
...
SHARED_LAYER_ACCESS_POLICY: Final[SharedLayerAccessPolicy] = (
    SharedLayerAccessPolicy(
        ...
        temporary_root="main-system/runtime/temp/shared-layer",
...
IDENTITY_GROUP_DOMAIN_TERM_EXTRACTOR: Final[str] = "identity-group-T00001"
...
IDENTITY_GROUP_CHINESE_SEMANTIC_ENGINE: Final[str] = "identity-group-S00002"
