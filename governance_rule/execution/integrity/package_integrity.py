...
def verify_packaged_app(
    ...
    *,
    ...
    if project_root is not None:
        from .package_integrity_sources import _verify_package_sources
        source_result = _verify_package_sources(metadata, project_root)
        if source_result.get("ok") is False:
            return source_result
        source_check = source_result.get("source_check", source_check)
