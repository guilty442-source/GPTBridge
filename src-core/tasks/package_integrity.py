...
def declared_source_exclusions(
    ...
    if re.fullmatch(r"[a-z0-9][a-z0-9_-]{1,63}", tool_id) is None:
        return None
    manifest_path = project_root / "platform_tools" / tool_id / "manifest.json"
    try:
    ...
    if normalized is None:
        return None
    prefix = PurePosixPath("platform_tools") / tool_id
