...
service._source_ui_processes["star-chat"] = RunningProcess()

# Check if star-chat is in _source_ui_processes
print('star-chat in _source_ui_processes:', 'star-chat' in service._source_ui_processes)
print('star-chat process:', service._source_ui_processes.get('star-chat'))
print('star-chat returncode:', service._source_ui_processes.get('star-chat').returncode if service._source_ui_processes.get('star-chat') else 'None')