...
from .investment_contract import upgrade_compatibility_contract
...
MOBILE_PLATFORM_NAME = "AI投資管家原生手機共用平台"
MOBILE_PLATFORM_CONTRACT_VERSION = 1
...
def mobile_platform_contract() -> dict[str, Any]:
    """Describe the stable contract shared by desktop and Android clients."""
    ...
    return {
        ...
        "upgrade_compatibility": upgrade_compatibility_contract(),
