...
- **整份藍圖單一任務面（2026-09-23 整合）**：§1–2 只定義目標與邊界，§4–12 只保存設計、依賴與驗收規格，
  §3.2 是唯一 current 未完成項 authority，§3.1 只表達其優先級，§3.3–3.5 只補充交接條件；其他章節不得再建立平行待辦、
  第二套編號或獨立完成狀態。同一工作跨章出現時以一個 G 編號統合，其他位置只引用該 G 編號。
