...
- Embedding 維度／index 相容性：漂移後新世代建置已由遷移工具觸發（migrate_schema → apply_migration → rebuild_canonical，見 P2 行）；殘項為 _generation_rebuild_required 生產觸發點接線與 G50 其餘呼叫點遷移。
