...
| P1 | **外部協作 EC-1–EC-8**（G36） | 細項：①送出／回覆鏈②session 管理④星澄研究路徑驗證⑤A544 幾何法典同步（staged request） |
...
| G36 | 外部協作未完善 | 送出／回覆鏈與 session 管理未端到端驗收；星澄研究路徑未驗證；A544 幾何法典同步待 staged request（詳 §4.2 P8） |
