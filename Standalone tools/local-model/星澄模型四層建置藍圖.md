...
| G84 | 【未完成】Preload 通道漂移（收斂中） | allowlist 機制已具；`app:set-ui-zoom`／`app:open-path` 已補 handler（`ipcHandlers.ts:176/196`）；**剩 `app:get-repair-status` 無 handler**；通道↔handler 契約測試仍缺 | 前端契約漂移（詳 §10.42） |
...
**統計**：完成 **36**、未完成 **55**（未完成：G2, G3, G5, G7, G8, G9, G12, G14, G15, G16, G17, G18, G19, G22, G24, G26, G27, G28, G29, G30, G31, G32, G34, G36, G38, G40, G41, G45, G47, G49, G57, G59, G60, G62, G64, G65, G66, G67, G68, G69, G70, G71, G72, G73, G74, G75, G76, G77, G80, G81, G83, G84, G85, G89, G91）。
