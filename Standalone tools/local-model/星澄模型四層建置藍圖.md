...
| P0 | **主系統 Python 常駐外移**（§1.1 目標二） | 細項：①常駐職責清單化 — **已完成**（`main-system/config/resident-core.json`：11 常駐＋5 按需，模式/觸發/理由齊）②外移順序與替代宿主（C／服務／Electron）③過渡雙軌與回退④驗收（ready／RSS／CPU／零功能退化） |
