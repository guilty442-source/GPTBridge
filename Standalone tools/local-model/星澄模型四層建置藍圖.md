...
| G28 | 第二批效能缺口（S1–S8） | S1 SIMD dispatch、S2 tuner 平滑＋遲滯、S4 探針並行、S7 adaptive pool 接線、S8 可攜 benchmark 皆已落地；S6 評估結案（跨執行稽核快取違 fail-closed）；S3 facade import 約 25.4ms／3 modules（正式基線待補）；S5 RC 體積已實測（governance_rule 1214.07MB、venv 18.84MB、backend 4.61MB、shared-layer 4.24MB、shared_runtime 2.25MB） | 效能與載入負載（S5／S7 原發現與主樹不符，需重測） |
