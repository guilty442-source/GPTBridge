...
| G93 | 核心拓撲實作收斂 | `architecture_registry.json` 仍將 `sub-sovereign-orchestration` 與 `synchronization-sovereign` 標為 resident；依 A604 改為自動化核心 canonical identity，退役子主宰不得再成為 owner、route 或 execution identity。 |
