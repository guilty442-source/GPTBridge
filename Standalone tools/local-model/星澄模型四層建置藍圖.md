...
> **Process Lasso 參考整合（2026-09-22 總督指令；設計＋實作，預設全關）** `[處理中 @opencode 2026-09-22T13:35Z]`：
...
| E11 | **C++ 長時驗證／device-resident KV／bf16 GEMM／fp8＋eval tps C++ 量測路徑**（2026-09-22 總督裁定納入） `[處理中 @devin-cli/thread-7a6b 2026-09-22T13:50Z — 僅 eval tps C++ 量測路徑]` | 中：效能上限 | GPU 工具鏈 |
