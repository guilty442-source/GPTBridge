...
- **自動化集中（2026-09-22 總督核定）**：**「自動化核心」負責所有自動化業務及流程**（automation-sovereign 轉型之核心引擎）：
  Git 提交／同步、清理與保留 §10.67、資源管制與釋放 §10.64、發布／更新同步、按需啟動 §10.66、週期／觸發排程；
  統一編排與排程、統一審計與 kill switch；模組只執行、不得各自內建排程。
- **核心分工（2026-09-22 總督核定）**：**所有決策與治理由「決策核心」處理**（法典政策、裁決、fail-closed 判定）；
  **「權限核心」負責審計與測試**（權限目錄、身份、稽核審計、測試）；
  **「星澄助理」只稽查與法典對齊是否合規（合規稽查；詳細審計不在星澄）**；**任何執行與編排由「運行核心」處理**（任務編排、排程、事件迴圈、IPC、資源與生命週期之執行）；
