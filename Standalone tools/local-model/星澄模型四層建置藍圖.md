...
| P0 | **執行權與版本基礎**：Runtime Execution Lease（10.17，**先於藍綠上線**）、統一 Task Lifecycle（10.16）、Release Manifest（10.18）、開發／正式分離（10.19）、**Backend Lifecycle Contract（10.21）與 INTEGRATION 收斂（10.20，先盤點）** | worker | 規劃已定 |
