...
| P0 | 資源自動管制與自動釋放（§10.64）：工作者總帳 CPU≤10%／RAM≤30%、四項資源自動釋放 | 部分實作（2026-09-22）：worker-plane 歸屬＋總帳＋滯回控制律＋admission-hold 已接入 governor 與 activation broker；引擎/GPU 釋放走既有 auto_release；④暫停週期工作與釋放執行面待接線 |
