...
| G28 | 第二批效能缺口（S1–S8） | S1 已由純 C CPUID runtime dispatch＋AVX-512/AVX2/scalar 完成；S7 adaptive pool bound 已接入 live ConnectionManager（peek 不建池、set_max_size、2 tests PASS）；打包體積未實測；啟動序列未並行；tuner 步幅大；file-sorter 模組分散（詳 4.6） | 效能與載入負載（S5／S7 原發現與主樹不符，需重測） |
