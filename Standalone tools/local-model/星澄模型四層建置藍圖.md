...
- **原則**：**法典保持唯一權威**；業務規則**不是權威**（下層規則，subordinate）——由對應主宰（sovereign／module domain）持有，
  **不得與法典牴觸、不得自稱權威、不得繞過治理閘門**；衝突時一律以法典為準並 fail-closed。
  新增業務規則一律下放至對應主宰持有，**不再寫入法典**；法典對業務規則只保留引用（必要時）與權責歸屬。
