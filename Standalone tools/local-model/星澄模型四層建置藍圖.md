...
> 殘：periodic_scheduler（C 原型無 pausable/run_immediately 語義，需先補 C 側契約）、
> state_outbox、maintenance_controller 同法接線。
...
- A548（星澄自主修復）vs A366/A380/A408（使用者開關＋一次性確認）字面牴觸：**已裁定全面責任檢討；未施工** `[處理中 @devin 2026-09-22T13:52Z — 兩域界定＋三線權責檢討＋clarification amendment]`。細項：
