...
from .cleanup_repair_candidates import CleanupRepairCandidatesMixin
from .cleanup_repair_ops import CleanupRepairOpsMixin
from .cleanup_repair_apply import CleanupRepairApplyMixin
from .cleanup_repair_health import CleanupRepairHealthMixin


class CleanupRepairMixin(
    CleanupRepairCandidatesMixin,
    CleanupRepairOpsMixin,
    CleanupRepairApplyMixin,
    CleanupRepairHealthMixin,
):
    pass
