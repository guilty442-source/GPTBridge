"""Rules document reading and writing for file sorter CLI."""
...
from ..infrastructure.sorter_engine import ProfileSnapshot
...
def _read_python_rules_document(rules_path: Path, raw_text: str) -> list[Any]:
    try:
...
def _read_rules_document(rules_path: Path) -> list[Any]:
    ...
    try:
        ...
        raw_rules = _read_python_rules_document(rules_path, raw_text)
