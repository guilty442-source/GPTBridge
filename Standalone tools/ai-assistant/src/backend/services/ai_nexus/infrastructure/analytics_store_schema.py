...
from .analytics_store_lifecycle import AnalyticsStoreLifecycleMixin
from .analytics_store_connections import AnalyticsStoreConnectionMixin
from .analytics_store_backups import AnalyticsStoreBackupMixin
from .analytics_store_restore import AnalyticsStoreRestoreMixin
...
class InvestmentAnalyticsStoreSchema(
    AnalyticsStoreLifecycleMixin,
    AnalyticsStoreConnectionMixin,
    AnalyticsStoreBackupMixin,
    AnalyticsStoreRestoreMixin,
):
