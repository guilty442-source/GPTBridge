...
class ImportOperationsMixin:
    """Durable import operation lifecycle and polling responses."""
    ...
    def _execute_import_operation(
        ...
        summary = self._operation_summary(response, operation)
        return self.analytics_store.update_import_operation(
            operation_id,
            status="completed",
    ...
    async def _import_operation_response(
        ...
        if (
            ...
            operation, state, summary = self._queue_import_postprocess(
                operation_id,
                operation,
                summary,
                state,
    ...
    def _queue_import_postprocess(
        ...
        return operation, state, summary
